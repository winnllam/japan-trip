...
export const KEYS = {
  ...
  seasonalCalMig: 'jwh-cal-seasonalmig-v1',     // one-time flag: researched approx/seasonal events grouped under the "Seasonal (approx)" calendar
  seasonalTypeMig: 'jwh-cal-seasonaltypemig-v1',// one-time flag: restore real TYPE categories on seasonal events the v1 migration retyped (parent now carries the grouping)
