...
const ASSETS = [
  ...
  // self-hosted Leaflet + markercluster (was unpkg) — precached so the map works offline + never hits a CDN
  'assets/vendor/leaflet/leaflet.js', 'assets/vendor/leaflet/leaflet.css',
  'assets/vendor/leaflet/leaflet.markercluster.js', 'assets/vendor/leaflet/MarkerCluster.css', 'assets/vendor/leaflet/MarkerCluster.Default.css',
];
